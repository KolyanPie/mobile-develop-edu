package ru.mirea.gudzhal.yandexmaps;
...
public class MainActivity extends AppCompatActivity implements UserLocationObjectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMap().move(
                new CameraPosition(new Point(55.670005, 37.479894), 1f, 0.0f, 0.0f),
    ...
    @Override
    public void onObjectUpdated(@NonNull UserLocationView userLocationView, @NonNull ObjectEvent
            objectEvent) {
    }
